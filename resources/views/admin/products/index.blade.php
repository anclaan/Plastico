		  	...
		  	<div class="row">
  				<div class="col-md-6">
                      ...
                      @foreach ($produkty as $produkt)
                          ...
                          <td>{{$produkt->id}}</td>
				                  <td>{{$produkt->nazwa}}</td>
                          <td>{{$produkt->getProductType()}}</td>
				                  {{-- <td>{{action('ProductsController@getProductType')}}</td> --}}
				                  <td>
                    ...
                    <a href={{ action('ProductsController@showCreateForm')}} role="button" type="button" class="btn btn-success">Nowy produkt</a>
